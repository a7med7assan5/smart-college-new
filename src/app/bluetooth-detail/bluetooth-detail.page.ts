...
@Component({
  selector: 'app-bluetooth-detail',
  templateUrl: './bluetooth-detail.page.html',
  styleUrls: ['./bluetooth-detail.page.scss'],
})
export class bluetoothDetailPage implements OnInit {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private ble: BLE,
    private alertCtrl: AlertController, private ngZone: NgZone) {
